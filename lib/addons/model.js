...
const {service, socket_id, data, base_dir} = require('@drumee/server-essentials/lex/attribute');
const {STORAGE_FOLDER} = require('@drumee/server-essentials/lib/lex/constants');
