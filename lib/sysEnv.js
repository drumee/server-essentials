...
function load(chroot) {
  ...
  if (!existsSync(ui_location)) {/** Legacy  */
    ui_location = join(ui_base, 'dist', endpoint_name);
  }

  if (!existsSync(server_location)) {/** Legacy  */
    server_location = join(server_dir, 'dist', endpoint_name);
  }
